> **历史设计输入，不是当前功能或接口说明。**
>
> 本文保留最初的页面生成提示词，其中的示例账号、示例数据、MQTT、Permission Matrix 等内容
> 不代表当前实现。运行行为请以 [`../README.md`](../README.md)、
> [`ARCHITECTURE.md`](ARCHITECTURE.md) 和 [`openapi.yaml`](openapi.yaml) 为准。
