    ...
    QMetaObject::invokeMethod(m_server, [this]() {
        m_server->setMap({
            {QModbusDataUnit::HoldingRegisters,
             {QModbusDataUnit::HoldingRegisters, 0, 32}},
        });
...
void SimulatedPlc::tick() {
    ...
    // HR 5..31 are NOT driven here: writes routed in by the gateway's sink
    // window / bridge forward persist and are read straight back by the UI.
}
