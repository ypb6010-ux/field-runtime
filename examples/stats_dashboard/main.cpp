...
int main(int argc, char* argv[]) {
    ...
    auto subEvents = core->bus().subscribe<core::bus::TransportEvent>(
        [&out](core::bus::TransportEvent const& e) {
            QString kindStr;
            switch (e.kind) {
                case core::bus::TransportEventKind::Connected:    kindStr = "Connected"; break;
